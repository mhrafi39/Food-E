        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AutoAdjustPrice = table.Column<bool>(type: "boolean", nullable: false),
                    CurrentStock = table.Column<int>(type: "integer", nullable: false),
                    PreparedStock = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "CreatedAt", "Email", "Name", "PasswordHash", "Role", "UpdatedAt" },
                values: new object[] { new DateTime(2025, 3, 2, 10, 0, 0, 0, DateTimeKind.Utc), "admin@foode.com", "Admin", "$2a$11$8yQRKLf2QajuIHDH2dJkPu6OEPLTrmFGC4PFQNLIUlW30VzElFD2a", "Admin", new DateTime(2025, 3, 2, 10, 0, 0, 0, DateTimeKind.Utc) });
