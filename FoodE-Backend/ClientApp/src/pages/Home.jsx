...
const Home = () => {
  ...
  useEffect(() => {
    const fetchFeaturedItems = async () => {
      ...
      if (result.success) {
        // Get first 4 available items or filter by some criteria
        ...
        >
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-white/60 text-lg">No items available at the moment</p>
              <Link to="/menu" className="inline-block mt-4 text-brand hover:underline">
                Browse Full Menu
              </Link>
            </div>
          )}
